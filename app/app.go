...
func New(
	...
	app.BlockKeeper = *blockmodulekeeper.NewKeeper(
		...
		app.GetSubspace(blockmoduletypes.ModuleName),
	)
	blockModule := blockmodule.NewAppModule(appCodec, app.BlockKeeper, app.AccountKeeper, app.BankKeeper)
